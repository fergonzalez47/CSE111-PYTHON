...
def pressure_gain_from_water_height(height):
    ...
    presure = (WATER_DENSITY *  EARTH_ACCELERATION_OF_GRAVITY * height) / 1000;
    return presure;
    
    
def pressure_loss_from_pipe(pipe_diameter, pipe_length, friction_factor, fluid_velocity):
    
    pressure = ( -friction_factor * pipe_length * WATER_DENSITY * math.pow(fluid_velocity, 2)) / (2000 * pipe_diameter);
...
def pressure_loss_from_fittings( fluid_velocity, quantity_fittings):
    ...
    pressure = (-0.04 * WATER_DENSITY * math.pow(fluid_velocity, 2) * quantity_fittings) / 2000
...
def pressure_loss_from_pipe_reduction(larger_diameter,
    ...
    pressure = (-k * WATER_DENSITY * math.pow(fluid_velocity, 2)) / 2000;
    return pressure;
